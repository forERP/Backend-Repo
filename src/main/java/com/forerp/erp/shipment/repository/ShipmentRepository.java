...
public interface ShipmentRepository extends JpaRepository<Shipment, Long> {
    ...
    @Query(value = """
            ...
            where (
                :flowType is null
                or (:flowType = com.forerp.erp.shipment.domain.ShipmentFlowType.INBOUND and i is not null)
                or (:flowType = com.forerp.erp.shipment.domain.ShipmentFlowType.OUTBOUND and o is not null)
            )
    ...
    Page<Shipment> search(
            @Param("flowType") ShipmentFlowType flowType,
