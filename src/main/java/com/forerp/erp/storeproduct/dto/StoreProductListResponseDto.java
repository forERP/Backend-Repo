package com.forerp.erp.storeproduct.dto;
...
public class StoreProductListResponseDto {
    ...
    public StoreProductListResponseDto(Long productId, String sku, String name, String categoryName, BigDecimal msrpPrice, Long storeProductId, Integer quantity, SaleStatus saleStatus, BigDecimal salePrice) {
